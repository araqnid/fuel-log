...
fun jacksonTree(matcher: Matcher<JsonNode>) = matcher
...
fun jsonScalar(): Matcher<JsonNode> = !jsonObject() and !jsonArray()
...
class ObjectNodeMatcher(
    ...
    fun withAnyOtherProperties() = ObjectNodeMatcher(
            propertyMatchers,
            false)
    ...
    fun withProperty(key: String, n: Int): ObjectNodeMatcher = withProperty(key, jsonInt(n))
    fun withProperty(key: String, n: Long): ObjectNodeMatcher = withProperty(key, jsonLong(n))
    fun withProperty(key: String, x: Double): ObjectNodeMatcher = withProperty(key, jsonDouble(x))
    fun withProperty(key: String, b: Boolean): ObjectNodeMatcher = withProperty(key, jsonBoolean(b))
    fun withProperty(key: String, str: String): ObjectNodeMatcher = withProperty(key, jsonString(str))
    fun withPropertyJSON(key: String, json: String): ObjectNodeMatcher = withProperty(key, equivalentJsonNode(json))
}
